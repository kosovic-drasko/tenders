...
describe('ViewPrvorangirani routing resolve service', () => {
  ...
  let resultViewPrvorangirani: IViewPrvorangirani | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultViewPrvorangirani).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IViewPrvorangirani>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
