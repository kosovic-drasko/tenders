...
describe('Specifikacije Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'specifikacije', component: SpecifikacijeComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to specifikacijeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSpecifikacijeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSpecifikacijeIdentifier).toHaveBeenCalledWith(entity);
