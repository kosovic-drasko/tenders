...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../view-ponude.test-samples';

import { ViewPonudeService } from './view-ponude.service';

const requireRestSample: IViewPonude = {
...
describe('ViewPonude Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a ViewPonude', () => {
      // eslint-disable-next-line @typescript-eslint/no-unused-vars
      const viewPonude = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(viewPonude).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a ViewPonude', () => {
      const viewPonude = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(viewPonude).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should partial update a ViewPonude', () => {
    ...
    describe('addViewPonudeToCollectionIfMissing', () => {
      it('should add a ViewPonude to an empty array', () => {
        const viewPonude: IViewPonude = sampleWithRequiredData;
      ...
      it("should add a ViewPonude to an array that doesn't contain it", () => {
        const viewPonude: IViewPonude = sampleWithRequiredData;
        const viewPonudeCollection: IViewPonude[] = [sampleWithPartialData];
        expectedResult = service.addViewPonudeToCollectionIfMissing(viewPonudeCollection, viewPonude);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(viewPonude);
      });
      ...
      it('should add only unique ViewPonude to an array', () => {
        const viewPonudeArray: IViewPonude[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const viewPonudeCollection: IViewPonude[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const viewPonude: IViewPonude = sampleWithRequiredData;
        const viewPonude2: IViewPonude = sampleWithPartialData;
    ...
    describe('compareViewPonude', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareViewPonude(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareViewPonude(entity1, entity2);
        const compareResult2 = service.compareViewPonude(entity2, entity1);
