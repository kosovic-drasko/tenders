...
/**
 * Criteria class for the {@link tender.domain.Prvorangirani} entity. This class is used
 * in {@link tender.web.rest.PrvorangiraniResource} to receive all the possible filtering options from
